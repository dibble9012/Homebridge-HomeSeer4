...
globals.log("Garage Door interface is " + newDevice.config.interface_name + ", most likely a HomeSeer Virtual Device, using openingValue and closingValue to control door.")
			targetDoorState
